...
import static com.company.store.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.company.store.IntegrationTest;
import com.company.store.domain.Product;
import com.company.store.domain.enumeration.Sizer;
...
class ProductResourceIT {
    ...
    private static final Sizer DEFAULT_SIZER = Sizer.S;
    private static final Sizer UPDATED_SIZER = Sizer.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getSizer()).isEqualTo(DEFAULT_SIZER);
    ...
    @Test
    @Transactional
    void checkSizerIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setSizer(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].sizer").value(hasItem(DEFAULT_SIZER.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.sizer").value(DEFAULT_SIZER.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getSizer()).isEqualTo(UPDATED_SIZER);
